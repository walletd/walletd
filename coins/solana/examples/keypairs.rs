...
fn main() {
    ...
    println!("Pubkey is off curve (for system programs): {:?}", off_curve_address.is_on_curve()); // Not on the ed25519 curve, therefore not suitable for users
