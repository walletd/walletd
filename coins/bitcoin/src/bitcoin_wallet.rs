...
pub struct BitcoinWallet {
    ...
    #[zeroize(skip)]
    blockchain_client: Option<Box<dyn BitcoinConnector>>,
...
impl BitcoinWallet {
    ...
    pub fn set_blockchain_client(&mut self, client: Box<dyn BitcoinConnector>) {
    ...
    pub fn blockchain_client(&self) -> Result<&Box<dyn BitcoinConnector>, Error> {
