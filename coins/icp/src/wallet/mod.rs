...
impl IcpWallet {
   ...
   pub fn create_transaction(&self, to: Principal, amount: u64, memo: Option<u64>) -> Result<Transaction> {
       Ok(Transaction {
           from: self.principal,
           to,
           amount,
   ...
   pub async fn transfer(&self, _agent: &Agent, _to: Principal, _amount: u64, _memo: Option<u64>) -> Result<u64> {
       // Simplified implementation
