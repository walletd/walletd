...
// Re-export from canisters module
pub use canisters::{CanisterClient as InnerClient, SecurityValidator, SecurityError};
...
impl CanisterClient {
    ...
    pub async fn call<T>(&self, method: &str, _args: &[u8]) -> Result<T, CanisterError> 
