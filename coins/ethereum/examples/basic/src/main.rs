...
async fn main() {
    ...
    let transport = web3::transports::Http::new("https://goerli.infura.io/v3/933b67502c4340a7bf3e873f0de62073")?; // ganache-cli
    ...
    let endpoint = "https://goerli.infura.io/v3/933b67502c4340a7bf3e873f0de62073".to_string(); // endpoint aimed at infura
...
async fn get_accounts(eth_client: &EthClient) -> web3::Result<Vec<H160>> {
    ...
    //let transport = web3::transports::Http::new("http://localhost:8545")?;
    let transport = web3::transports::Http::new("https://ropsten.infura.io/v3/933b67502c4340a7bf3e873f0de62073")?;
    let web3 = web3::Web3::new(transport);
