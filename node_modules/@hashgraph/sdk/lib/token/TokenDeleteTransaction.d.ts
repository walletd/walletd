...
export default class TokenDeleteTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): TokenDeleteTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): HashgraphProto.proto.ITokenDeleteTransactionBody;
}
