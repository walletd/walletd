...
export default class TokenGrantKycTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): TokenGrantKycTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): HashgraphProto.proto.ITokenGrantKycTransactionBody;
}
export namespace HashgraphProto {
    namespace proto {
        ...
        type ITokenGrantKycTransactionBody = import("@hashgraph/proto").proto.ITokenGrantKycTransactionBody;
