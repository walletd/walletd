...
export default class TokenFreezeTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): TokenFreezeTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): HashgraphProto.proto.ITokenFreezeAccountTransactionBody;
}
