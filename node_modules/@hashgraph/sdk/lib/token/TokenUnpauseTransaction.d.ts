...
export default class TokenUnpauseTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): TokenUnpauseTransaction;
    /**
     * @param {object} [props]
     ...
     */
    protected override _makeTransactionData(): HashgraphProto.proto.ITokenUnpauseTransactionBody;
}
export namespace HashgraphProto {
    namespace proto {
        ...
        type ITokenUnpauseTransactionBody = import("@hashgraph/proto").proto.ITokenUnpauseTransactionBody;
