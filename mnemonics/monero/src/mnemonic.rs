...
/// to create a [`Mnemonic`][Mnemonic] by only specifying the options
...
/// The [`MnemonicBuilder::set_detect_language()`][MnemonicBuilder::set_detect_language()] function can be used to specify that the language should be automatically detected from the mnemonic phrase.
///
/// [Mnemonic]: ./mnemonic/struct.Mnemonic.html
/// [MnemonicBuilder]: ./mnemonic/struct.MnemonicBuilder.html
/// [Mnemonic::builder()]: ./mnemonic/struct.Mnemonic.html#method.builder
...
/// [MnemonicBuilder::set_detect_language()]: ./mnemonic/struct.MnemonicBuilder.html#method.set_detect_language
#[derive(Debug, Clone, Eq, PartialEq)]
    ...
    fn restore(&self) -> Result<Mnemonic, Error> {
        ...
        if let Some(phrase) = &self.phrase {
            ...
            if let Some(language) = self.language {
                ...
                // Language was not specified, detect it
            ...
            let mnemonic_type = self.mnemonic_type.ok_or_else(|| {
                Error::MissingInformation(
                    "mnemonic type must be specified to recover a mnemonic from a seed".to_owned(),
                )
            })?;

            // Assuming the seed provided corresponds to the mnemonic phrase
...
mod tests {
    ...
    fn test_detect_language() {
        ...
        mnemonic_builder.set_detect_language();
    ...
    //     let mnemonic = Mnemonic::from_phrase(Language::English, mnemonic_phrase, Some(provided_passphrase)).unwrap();
    //     let actual_seed_hex = mnemonic.to_seed().to_string();
    //     let expected_encrypted_seed_hex = "294d3c091d80e36cf2a551ed3ee36c694dda232d8e6b9ea5de8f7442c01fa50d";
