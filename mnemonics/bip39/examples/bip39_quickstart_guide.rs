...
fn main() -> Result<(), walletd_bip39::Error> {
    ...
    println!("mnemonic seed hex: {:x}", mnemonic.seed());
    // can use the as_bytes method to get the seed as a byte array
    println!("mnemonic seed as bytes: {:?}", mnemonic.seed().as_bytes());
    ...
    println!("mnemonic_1 seed hex: {:x}", mnemonic_1.seed());
    ...
    println!("mnemonic_2 seed hex: {:x}", mnemonic_2.seed());
    println!(
    ...
    println!("mnemonic_3 seed hex: {:x}", mnemonic_3.seed());
    ...
    assert_eq!(format!("{:x}", restored_mnemonic_1.seed()), seed_hex_1);
    println!(
    ...
    assert_eq!(format!("{:x}", restored_mnemonic_2.seed()), seed_hex_2);
    println!(
