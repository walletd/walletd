...
use crate::{Bip39Language, MnemonicType, ParseMnemonicError, WordList};
use bitvec::prelude::*;
...
impl MnemonicExt for Bip39Mnemonic {
    ...
    /// optional passphrase
    fn new(language: Bip39Language, mnemonic_type: MnemonicType, passphrase: Option<&str>) -> Self {
...
mod tests {
    ...
    fn test_print() {
        ...
        let mnemonic = Bip39Mnemonic::builder().mnemonic_phrase(phrase).build().unwrap();
...
"a2fd9c0522d84d52ee4c8533dc02d4b69b4df9b6255e1af20c9f1d4d691689f2a38637eb1ec778972bf845c32d5ae83c7536999b5666397ac32021b21e0accee"
    ...
    fn test_from_phrase_invalid_length() {
        ...
        assert!(Bip39Mnemonic::builder().mnemonic_phrase(phrase).build().is_err());
    }
